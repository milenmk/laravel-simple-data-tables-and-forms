<div class="form-field-wrapper {{ $errors->has("formData." . $field->name) ? "has-error" : "" }}">
    ...
    @if ($field->searchable)
        ...
        <div
            x-data="searchableSelect({
                        ...
                        placeholder:
                            '{{ $field->placeholder ?: ($field->emptyOption ?: "Select an option...") }}',
        ...
        >
            ...
            <button
                ...
                class="searchable-select-trigger {{ $field->multiple ? "form-multiselect" : "form-select" }} {{ $field->disabled ? "cursor-not-allowed opacity-50" : "" }} flex w-full items-center justify-between text-left"
            ...
            >
                ...
                <div class="ml-2 flex items-center gap-2">
                    <template x-if="selectedOptions.length > 0 && ! {{ $field->disabled ? "true" : "false" }}">
                        <button
                            type="button"
                            @click.stop="clear()"
    ...
    @else
        ...
        <select
            ...
            class="{{ $field->multiple ? "form-multiselect" : "form-select" }} {{ $field->disabled ? "cursor-not-allowed opacity-50" : "" }}"
            @if ($field->required) required @endif
