...
class AssetService
{
    ...
    public function getCssTag(): string
    {
        ...
        $lazyLoad = Config::get('simple-datatables-and-forms.assets.lazy_load', true);
    ...
    public function getCssPath(): string
    {
        ...
        return asset('vendor/milenmk/laravel-simple-datatables-and-forms/css/package.css');
    }
    ...
    public function getJsTag(): string
    {
        ...
        $deferJs = Config::get('simple-datatables-and-forms.assets.defer_js', true);
    ...
    public function getJsPath(): string
    {
        ...
        return asset('vendor/milenmk/laravel-simple-datatables-and-forms/js/package.js');
    }
}
